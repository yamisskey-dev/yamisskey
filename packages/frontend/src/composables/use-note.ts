...
export function useNote(
	...
	const canRenote = !(appearNote.isNoteInYamiMode && !appearNote.localOnly) && (['public', 'home'].includes(appearNote.visibility) || (appearNote.visibility === 'followers' && appearNote.userId === $i?.id));
