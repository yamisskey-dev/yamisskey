...
>
	...
	<template v-else-if="page === 3" #header><i class="ti ti-id-badge"></i> {{ i18n.ts.communityRole }}</template>
...
import XCommunityRole from '@/components/MkUserSetupDialog.CommunityRole.vue';
