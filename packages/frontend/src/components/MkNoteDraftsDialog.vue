							...
							<div :class="$style.draftBody" class="_gaps_s">
								...
								<div :class="$style.draftFooter">
									<div :class="$style.draftVisibility">
										...
										<span v-if="draft.visibility === 'specified' && (!draft.visibleUserIds || draft.visibleUserIds.length === 0)" :title="i18n.ts._visibility['private'] || i18n.ts._visibility['specified']">
											<i class="ti ti-eye-off"></i>
										</span>
										<span v-else :title="i18n.ts._visibility[draft.visibility]">
